...
public class ChessMatch {
	...
	private void initialSetup() {
		...
		placeNewPiece('b', 1, new Horse(board, Color.BRANCA));
		placeNewPiece('g', 1, new Horse(board, Color.BRANCA));
		...
		placeNewPiece('b', 8, new Horse(board, Color.PRETA));
		placeNewPiece('g', 8, new Horse(board, Color.PRETA));
